...
public class AttackState : UnitDefaultState
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        baseAttack = animator.gameObject.GetComponent<BaseAttack>();
    ...
    {
        if (unitFindTarget.Target == null || Vector3.Distance(animator.transform.position, unitFindTarget.Target.position) > unitCombat.MinDistanceToTarget + 0.5f)
        {
